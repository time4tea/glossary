...
Glossary.prototype.prepare = function() {
    return new Glossariser(this._items);
};
...
var Glossariser = function(terms) {
...
Glossariser.prototype.gloss = function (text) {

    var tree = new BTree();

    var splits = [];

    Aho.search(text, this._trie, function (found_word, index, data) {
